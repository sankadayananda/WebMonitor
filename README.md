...
### Notes
 > This is not a fully fledged application that is capable of handling all Web Site errors. The links in the below guide will show screen captures from the AWS Console. 
